                     ...
                     <div className="space-y-2">
                       <div className="flex items-center text-yellow-400">
                        ...
                        <div className="flex items-center text-yellow-400">
                          ...
                          Max 2 tokens per week
                        </div>
                        <div className="flex items-center text-yellow-400">
                          <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                          </svg>
                          Max 7% creator allocation
                        </div>
                     </div>
                   </div>
                   ...
                   <div className="card">
                     ...
                     <div className="space-y-3">
                       <div className="flex justify-between items-center">
                         ...
                         <span className="text-green-400 font-semibold">0.03 SOL</span>
                       </div>
                                               <div className="flex justify-between items-center">
                       ...
                       <div className="flex justify-between items-center">
                         ...
                         <span className="text-green-400 font-semibold">0.01 SOL</span>
                       </div>
                       <div className="pt-2 border-t border-gray-700">
                         <div className="flex justify-between items-center">
                           <span className="text-gray-300">Total Estimated Fees:</span>
                           <span className="text-white font-semibold">0.04 SOL</span>
                         </div>
                       </div>
                     </div>
                   </div>
